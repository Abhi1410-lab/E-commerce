...
mongoose.connect("mongodb+srv://abhisolanki:Abhi@cluster0.snideoh.mongodb.net/e-commerce")
...
//Creating API to fetch all the products
...
//Creating API to store the cart data
...
//Creating API to get all cart data of a user
